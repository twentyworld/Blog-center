...
![InfrastructureAdvisorAutoProxyCreator类图](spring-transaction.assets/InfrastructureAdvisorAutoProxyCreator.jpg)
...
![BeanFactoryTransactionAttributeSourceAdvisor类图](spring-transaction.assets/BeanFactoryTransactionAttributeSourceAdvisor.jpg)
...
![TransactionAttributeSourcePointcut类图](spring-transaction.assets/TransactionAttributeSourcePointcut.jpg)
...
![DataSourceTransactionManager](spring-transaction.assets/DataSourceTransactionManager.jpg)
...
![DriverManagerDataSource类图](spring-transaction.assets/DriverManagerDataSource.jpg)
...
![DataSourceTransactionObject类图](spring-transaction.assets/DataSourceTransactionObject.jpg)

###### Savepoint

位于java.sql包下，对于Mysql来说，由Mysql驱动提供实现，类图:

![Savepoint类图](spring-transaction.assets/Savepoint.jpg)
