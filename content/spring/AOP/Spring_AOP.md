...
![AspectJExpressionPointcut类图](Spring_AOP.assets/AspectJExpressionPointcut.jpg)
...
![aopalliance包](Spring_AOP.assets/aopalliance.png)
...
![DefaultBeanFactoryPointcutAdvisor类图](Spring_AOP.assets/DefaultBeanFactoryPointcutAdvisor.jpg)
...
![RuntimeBeanReference类图](Spring_AOP.assets/RuntimeBeanReference.jpg)
...
![DeclareParentsAdvisor类图](Spring_AOP.assets/DeclareParentsAdvisor.jpg)

#### 其它

此处的其它指的是aop:before, aop:after等最核心的标签。其最终被解析为beanClass为AspectJPointcutAdvisor的BeanDefinition，类图:

![AspectJPointcutAdvisor类图](Spring_AOP.assets/AspectJPointcutAdvisor.jpg)
...
![MethodLocatingFactoryBean类图](Spring_AOP.assets/MethodLocatingFactoryBean.jpg)
...
![SimpleBeanFactoryAwareAspectInstanceFactory类图](Spring_AOP.assets/SimpleBeanFactoryAwareAspectInstanceFactory.jpg)
...
![AspectJAwareAdvisorAutoProxyCreator类图](Spring_AOP.assets/AspectJAwareAdvisorAutoProxyCreator.jpg)
...
![AOP逻辑图](Spring_AOP.assets/aop_logic.jpg)
...
![TargetSource类图](Spring_AOP.assets/TargetSource.jpg)
...
![ScopedProxyBeanDefinitionDecorator类图](Spring_AOP.assets/ScopedProxyBeanDefinitionDecorator.jpg)
...
![ScopedProxyFactoryBean类图](Spring_AOP.assets/ScopedProxyFactoryBean.jpg)
...
![DelegatingIntroductionInterceptor类图](Spring_AOP.assets/DelegatingIntroductionInterceptor.jpg)
...
![Callback类图](Spring_AOP.assets/Callback.jpg)
...
![CallbackFilter类图](Spring_AOP.assets/CallbackFilter.jpg)
...
![Cglib调用流程](Spring_AOP.assets/cglib_invocation.png)
