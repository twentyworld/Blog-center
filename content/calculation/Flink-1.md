...
[Java随想录](javascript:void(0);)

 *2023年10月23日 12:00* *浙江*



> 本文字数：18640字，阅读大约需要60分钟。
...
![图片](/Users/temperlee/git-repo/knowledge-repo/Blog-center/content/calculation/Flink-1.assets/640-20250629175928888)
...
![图片](/Users/temperlee/git-repo/knowledge-repo/Blog-center/content/calculation/Flink-1.assets/640)
...
![图片](/Users/temperlee/git-repo/knowledge-repo/Blog-center/content/calculation/Flink-1.assets/640-20250629175928889)

当Source数据源的数量比较大或计算逻辑相对比较复杂的情况下，需要提高并行度来处理数据，采用并行数据流。

通过设置不同算子的并行度，比如 Source并行度设置为2 ，map也是2。代表会启动2个并行的线程来处理数据：

![图片](/Users/temperlee/git-repo/knowledge-repo/Blog-center/content/calculation/Flink-1.assets/640-20250629175928893)
...
![图片](/Users/temperlee/git-repo/knowledge-repo/Blog-center/content/calculation/Flink-1.assets/640-20250629175928884)
...
![图片](/Users/temperlee/git-repo/knowledge-repo/Blog-center/content/calculation/Flink-1.assets/640-20250629175928891)
...
![图片](/Users/temperlee/git-repo/knowledge-repo/Blog-center/content/calculation/Flink-1.assets/640-20250629175928948)
