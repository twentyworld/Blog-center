...
![表1-1 维基百科的编辑事件流数据](druid/4e1cd45f-ab9e-439c-af35-9c8d3ec66218.png)
...
![图2-1 Druid的数据分区过程](druid/cd43c03f-d7bb-4b76-834c-280b4c81b3de.png)
...
![6c6b35bd-a874-4599-b64f-3a0a0b614a93](druid/6c6b35bd-a874-4599-b64f-3a0a0b614a93.png)
...
![图2-3 维度列的存储（以advertiser为例）](druid/869ccf64-9976-4ece-8840-b8a81d742456.png)
...
![图2-4 位图计算](druid/616e3974-8894-4871-bc28-4a63a40136c9.png)
...
![图3-1 Druid离线数据摄入](druid/5c27d610-de66-4be1-a821-2f6e596243b4.png)
...
![图3-2 Scatter-Gather查询处理](druid/45bbcf7d-630f-468e-a795-ee8f2de79edf.png)
...
![图4-1 RealTime Node同时提供In-Memory Index和Persisted Index的查询](druid/c24b2d72-94dd-4f29-b020-8717f449e579.png)
...
![图4-2 ](druid/ea99d68c-26b5-4802-b6e5-a1f3df89e51d.png)

# 5 总体架构

讲到这里，我们可以直接来看Druid的总体架构（图5-1），把前面提到的各个部分串联起来。

![图5-1 Druid总体架构](druid/4484b206-41d4-4b97-94e1-c4ad287b60f5.png)
...
![图6-1 Druid SSB测试结果](druid/1ca6a1aa-7ad5-4d56-b010-fafdf3d84a19.png)
...
![图6-2 增加Historical Node前后性能对比](druid/00fadc82-d72c-4ca7-a7d3-8b2ae7419027.png)
